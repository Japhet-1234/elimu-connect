...
const translations = {
  en: {
    ...
    footerDesc: 'Waza Elimu African Edition - Bridging the gap between tradition and digital learning.',
  ...
  sw: {
    ...
    footerDesc: 'Waza Elimu Toleo la Kiafrika - Kuziba pengo kati ya mila na ujifunzaji wa kidijitali.',
